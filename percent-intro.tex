...
\note[item]{\alert<3>{Following the order of the sentence, we set up an equation. Read the origianl equation from left to right to build the equation.}}
\note[item]{\alert<4>{24}}
...
\note[item]{\alert<6>{Because it will help us later, we can say say that we have 1x instead of just x.}}
\pause
