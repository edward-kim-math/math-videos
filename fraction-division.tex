...
\note[item]{\alert<6>{Replace dividing by three sevenths with multiplying by seven thirds.}}
...
\note[item]{\alert<3>{Replace dividing by seven elevenths with multiplying by eleven sevenths.}}
