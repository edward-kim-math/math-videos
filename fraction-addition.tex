...
\note[item]{\alert<5>{For the first fraction, multiply the top and the bottom by seven. We haven't finished this step, which explains the space after the plus sign.}}
...
\pause 
\note[item]{\alert<2>{We could rewrite both fractions to have sixty in the denominator, but ten and six both have a common factor of two, so we will rewrite both fractions to have thirty in the denominator.}}
