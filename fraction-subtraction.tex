...
\note[item]{\alert<5>{For the first fraction, multiply the top and the bottom by two. We haven't finished this step, which explains the space after the minus sign.}}
