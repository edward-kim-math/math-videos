...
\pause $5v = 3 \times 270$
\note[item]{\alert<5>{When we have one fraction equal to another fraction, can cross multiply. (In another setting, when we were multiplying to fractions, we can't do that, and instead we multiply straight across.) So 5 times v equals 3 times 270.}}
...
\pause $v = 162$
\note[item]{\alert<7>{To solve for v, we divide both sides of the equation by 5. So v equals 810 divided by 5. Simplified, v eqauls 162.}}
...
\vskip10pt
\pause
{\bf Solution.} In this problem, we don't know how many people ordered pizza, and we don't know how many people oredered pasta. 
\note[item]{\alert<2>{In this problem, we don't know how many people ordered pizza, and we don't know how many people oredered pasta.}}
...
\vskip4pt
\pause As another way to answer, we can go back to seeing that there are $7$ total groups and set up a part-to-whole propotion.
\note[item]{\alert<7>{As another way to answer, we can go back to seeing that there are 7 total groups and set up a part-to-whole propotion.}}
...
\vskip4pt
\pause $7p = 3500$
\note[item]{\alert<9>{When we have one fraction equal to another fraction, can cross multiply. So 7 times p equals 4 times 875.}}
